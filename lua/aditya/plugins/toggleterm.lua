...
-- Setup a general floating terminal using PowerShell
local floating_terminal = Terminal:new({
  direction = "float",
  cmd = "powershell.exe",  -- This will open PowerShell in the floating terminal
...
-- Toggle the general floating terminal with F7 and control + 7 in normal mode
vim.api.nvim_set_keymap('n', '<F7>', '<cmd>lua toggle_floating_terminal()<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-7>', '<cmd>lua toggle_floating_terminal()<CR>', { noremap = true, silent = true })

-- Toggle the general floating terminal with F7 and control + 7 in terminal mode
vim.api.nvim_set_keymap('t', '<F7>', '<C-\\><C-n><cmd>lua toggle_floating_terminal()<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('t', '<C-7>', '<C-\\><C-n><cmd>lua toggle_floating_terminal()<CR>', { noremap = true, silent = true })
